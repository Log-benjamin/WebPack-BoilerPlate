...
<div align="center">
  <h2><b>WebPack - Boiler Plate</b></h3>
</div>
# 📗 Table of Contents
...
### 📖A Webpack Boiler Plate <a name="about-project"></a>

This repo container all the starter files of webpack which I will be using for the future projects.
...
```sh
"git clone https://github.com/Log-benjamin/WebPack-BoilerPlate.git"
```
...
- I will add more package and dependencies to be used on different projects 
